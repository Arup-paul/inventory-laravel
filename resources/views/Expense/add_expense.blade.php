            ...
            <form role="form" action="{{url('/insert-expense')}}" method="post" enctype="multipart/form-data">
                  ...
                  @endif
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="details" id="one" class="form-control" cols="30" rows="10"></textarea>
                    </div>

                    <div class="form-group">
                        <label for="two">Amount*</label>
                        <input type="text" class="form-control" name="amount" id="two" placeholder="Enter Amount">
                    </div>
