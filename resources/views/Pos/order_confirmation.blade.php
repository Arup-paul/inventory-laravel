                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="hidden-print">
                                <div class="pull-right">
                                <a href="{{URL::to('/downloadPDF/'.$order->id)}}" class="btn btn-sm btn-primary pull-right btn btn-sm  btn-primary waves-effect waves-light" >Download Pdf</a>
                                </div>
                            </div>
                            @else
                            <div class="hidden-print">
                                ...
                                <a href="{{URL::to('/order-confirm-pos/'.$order->id)}}" class="btn btn-sm btn-primary pull-right btn btn-sm  btn-primary waves-effect waves-light" >Done</a>
                                </div>
                            </div>
                            @endif
                        </div>
